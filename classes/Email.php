...
class Email{
    ...
    public function enviarConfirmacion(){
        ...
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong>, Has creado tu cuenta en App 
                            Salon, solo debes confirmarlo dando click en el siguiente enlace.</p>";
    ...
    public function enviarInstrucciones(){
        ...
        $contenido = "<html>";
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong>, Has solicitado reestablecer tu Password en App 
                            Salon, solo debes dar click en el siguiente enlace.</p>";
        $contenido .= "<p>Presiona aquí: 
